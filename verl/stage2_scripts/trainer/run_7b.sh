export N_GPUS=4
export BASE_MODEL='arm-team/ARM-Stage1-7B'
...
export ROUTER_BETA=1.0
export ROUTER_RHO=0.2
export ROUTER_LR=1e-3

# Auto-generated experiment name
export EXPERIMENT_NAME="arm-7B-${N_GPUS}gpu-b${ROUTER_BETA}-r${ROUTER_RHO}-lr${ROUTER_LR}"
...
python3 -m verl.trainer.my_ppo \
    ...
    algorithm.router_beta=$ROUTER_BETA \
    ...
    +trainer.push_to_hub=tp140205/$EXPERIMENT_NAME \
    $@
