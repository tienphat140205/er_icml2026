...
python3 -m verl.trainer.my_ppo \
    ...
    algorithm.router_beta=1.0 \
    algorithm.router_rho=0.2 \
    ...
    router.optim.lr=1e-3 \
    router.forward_micro_batch_size_per_gpu=256 \
    router.router_mini_batch_size=256 \
    router.router_micro_batch_size_per_gpu=64 \
    ...
    trainer.push_to_hub_actor=tp140205/arm-actor \
    trainer.push_to_hub_router=tp140205/arm-router \
    $@
